# Memo Task — Timing Candidates Memo
...
Which deviations may be payment timing rather than real variance?
...
Timing candidate must not be called confirmed timing.

## Required blocks

- Timing candidates.
- Expected reversal month.
- Candidate confidence.
- Month shift candidates.
- Open questions.

## If methodology is missing

Produce candidate-only memo or methodology gap.
