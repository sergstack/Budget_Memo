# Memo Task — CFO Owner Localization Memo
...
Which signals sit inside a selected CFO / responsibility area?
...
If no CFO is selected:
- block; or
- use top CFO from localization signals only with explicit approval.

## Required blocks

- Article × CFO.
- Top articles inside CFO.
- Counterparties.
- Plan-Fact.
- YoY / MoM.
- Actions.
