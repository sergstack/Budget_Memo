# Memo Task — Forecast Run-Rate Memo
...
What will month/quarter look like at current pace?
...
Do not build until forecast / run-rate methodology is approved.

## If methodology is missing

Create methodology requirements and no DOCX.
