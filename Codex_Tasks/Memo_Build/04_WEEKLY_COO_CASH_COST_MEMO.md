# Memo Task — Weekly COO Cash Cost Memo
...
What changed during the week and what needs COO attention?
...
Do not build final weekly memo until weekly / MTD / run-rate methodology is approved.
...
- Weekly change by article.
- MTD vs expected run-rate.
- IN / OUT / IN-OUT weekly context.

## If weekly grain is missing

Produce methodology gap report, not DOCX.
