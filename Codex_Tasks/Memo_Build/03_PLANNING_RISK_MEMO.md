...
Where does future plan differ from historical base?
...
- Months of base.
- Weak / missing base.
- IN context if denominator is valid.
- Owner route.

## Required charts

- Top plan vs historical base by EUR.
- Weak base / no base summary.
- Article × CFO plan risk localization.

## Required Excel outputs

Planning risk slice workbook.

## Stop conditions

- Planning risk is written as actual execution.
- No historical base logic.
- No base availability fields.
