# Memo Task — IN OUT Pressure Memo
...
Which articles grow disproportionately to IN?
...
- IN / OUT / IN-OUT Definition Card.
- Deviation to IN.
- Fact to IN.
- Plan to IN.
- Flow pressure.
- Valid denominator status.

## Required charts

- Top deviations to IN.
- IN / OUT / IN-OUT trend.
- Article pressure vs IN.

## Stop conditions

- No Definition Card.
- Invalid denominator.
- IN-OUT summed across ordinary article rows.
